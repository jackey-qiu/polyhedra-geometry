...
#different from the version 3:p0,p1,p2 and apex will be on the same plane (very impossible),p2 will be calculated in the same way as apex, but different r
